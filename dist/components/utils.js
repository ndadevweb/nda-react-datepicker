...
export function getDays(dateSelected) {
  ...
  const previousMonthTotalDaysToKeep = (currentDateFirstDay.getDay() + MAX_INDEX_WEEKDAY) % TOTAL_DAYS_IN_WEEK;
  ...
  const daysLeft = days.length > MAX_CELLS_FOR_FIVE_ROWS ? MAX_CELLS_FOR_SIX_ROWS - days.length : MAX_CELLS_FOR_FIVE_ROWS - days.length;
